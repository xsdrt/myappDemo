...
func (u *User) GetAll() ([]*User, error) { //Passing the condition to this func "GetAll Users" from the DB using a slice of a pointer to all users... "
...
func (u *User) GetByEmail(email string) (*User, error) { //Look the users up by email and gets one user, by email...
...
func (u *User) Get(id int) (*User, error) { //Get only (1) one user by Id....
	var theUser User
	collection := upper.Collection(u.Table())
